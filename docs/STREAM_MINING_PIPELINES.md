...
- [Pipeline 3: Local Model Training with Federated Updates](#pipeline-3-local-model-training-with-federated-updates)
  - [Random Cut Forest (RCF) Algorithm - Deep Dive](#random-cut-forest-rcf-algorithm---deep-dive)
  - [What RCF Actually Uses (Stream Mining Techniques)](#what-rcf-actually-uses-stream-mining-techniques)
  - [RCF Configuration in This Project](#rcf-configuration-in-this-project)
