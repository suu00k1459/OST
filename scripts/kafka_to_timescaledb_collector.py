...
KAFKA_BROKERS = os.getenv('KAFKA_BROKERS', 'kafka-broker-1:29092,kafka-broker-2:29093,kafka-broker-3:29094,kafka-broker-4:29095').split(',')
KAFKA_TOPIC = os.getenv('KAFKA_TOPIC', 'edge-iiot-stream')
